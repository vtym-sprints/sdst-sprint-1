...
public class BuildYourOwnElements extends AbstractBasePage {
    ...
    public static final String CHOSE_YOUR_EXTERIOR_PART = "//div[@class='byo-rail-list-view']";
    ...
    public static final String TRIM = "//input[@id='Trim_selector']";
    ...
    public static final String SEE_ALL_8_FEATURES = "//div[contains(text(),'8 features')]";
    public static final String SOUND_SYSTEM = "//input[@id='S06F1']";
    ...
    public static final String PRICE_OF_CLIMATE_COMFORT =
            "//*[@id='conflict-modal']/div[2]/div/section[2]/div[1]/div[1]/div/div[1]/div/p[2]";
    public static final String PRICE_EXECUTIVE_PACKAGE =
    ...
    public static final String TOTAL_PRICE_x7 = "//div[@class='build-overview__total-price label-1--bold']";
