...
public class HomePageElements extends AbstractBasePage {
    ...
    public static final String SHOPPING_BUTTON = "//button[@name='Shopping Flyout']";
    public static final String SHOP_INVENTORY_BUTTON = "//a[@title='Shop Inventory']";
    public static final String SHOPPING_ZIP_CODE_FIELD = "//input[@id='zip_code']";
    public static final String SHOP_PRE_OWNED_BUTTON_IN_SHOPPING_TAB = "//button[@name='zip_btn_secondary']";
    public static final String CARS_IN_AVAILABILITY = "//a[@id='button-f4e1544f40'] ";
    public static final String PRESS_BMW_ELECTRIC_BTN = "//a[contains(text() , 'BMW Electric')]";
}
