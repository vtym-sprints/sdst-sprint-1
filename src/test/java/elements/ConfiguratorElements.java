...
public class ConfiguratorElements extends AbstractBasePage {
    ...
    protected static final String BUTTON_SELECT_EXECUTIVE_PACKAGE_FEATURES =
            "//p[@class='package-tile__name headline-5--bold' and contains(text(), 'Executive')]" +
                    "//ancestor::div[@class='package-tile']//div[@class='package-tile__see-all-btn content-2']";
